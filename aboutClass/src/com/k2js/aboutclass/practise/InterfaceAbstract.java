...
interface InterfaceAbstract{
	static int i=10;
	int j =20; //interface variables are by default public static final
...
class InterfaceAbstractTest{
	...
	public static void main(String...xxyy){
		...
		//System.out.println(new InterfaceAbstract(){}.j);//if interface variables are not by default public static final
